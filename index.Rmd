...
This is a template for a data analysis folder that can be easily exported as a [**webpage**](https://realitybending.github.io/TemplateResults/) or as **Supplementary Materials** (e.g., as a [Word document](https://realitybending.github.io/TemplateResults/word_and_pdf/) or a PDF). 
...
- [x] Rendered as a [README page](https://github.com/RealityBending/TemplateResults/blob/main/README.md), a [published website](https://realitybending.github.io/TemplateResults/) and a [word document](https://github.com/RealityBending/TemplateResults/raw/main/word_and_pdf/SupplementaryMaterials.docx)
- [x] APA citations
